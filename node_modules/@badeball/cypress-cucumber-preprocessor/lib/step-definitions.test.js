...
function pre10example(filepath, cypressConfiguration, preprocessorConfiguration, expected) {
...
function post10example(filepath, cypressConfiguration, preprocessorConfiguration, expected) {
    it(`should return [${expected.join(", ")}] for ${filepath} with ${util_1.default.inspect(preprocessorConfiguration)} in ${cypressConfiguration.projectRoot}`, () => {
